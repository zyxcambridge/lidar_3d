...
RUN cd ./spconv && git checkout 8da6f967fb9a054d8870c3515b1b44eca2103634 && git submodule sync && git submodule update --init --recursive && python setup.py bdist_wheel
